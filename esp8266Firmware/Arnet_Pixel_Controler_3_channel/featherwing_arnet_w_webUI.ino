...
const char *ssid = "featherwing4"; //HotSpot Password, use web UI to setup local wifi
const char *password = "mshort123";
bool startupMode=true;
bool wifiConnected=false;
ESP8266WebServer server(80);
struct {
  char ssid[256] = "inititial_wifi_name";
  char password[256] = "inititial_wifi_pwd";
  char universe[32] = "2";
  char startChan[32] = "10";
}epdata;
